...
function deliver_scripts() {
    ...
    wp_enqueue_style( 'carousel-style', get_template_directory_uri() . '/bower_components/slick-carousel/slick/slick.css');
    wp_enqueue_style( 'carousel-style', get_template_directory_uri() . '/bower_components/slick-carousel/slick/slick-theme.css');
